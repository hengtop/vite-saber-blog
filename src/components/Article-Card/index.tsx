 ...
 * @LastEditTime: 2022-01-24 23:07:18
 */
  ...
  return (
    ...
    >
      ...
      <div className="flex-auto py-2 md:py-4 px-4 overflow-hidden overflow-ellipsis">
        ...
        <p className="my-2 leading-6 text-gray-500  text-sm md:text-base line-clamp-1 sm:line-clamp-2 sm:h-48-[px] md:line-clamp-3 md:h-[72px] overflow-hidden overflow-ellipsis">
          {text}
        </p>
